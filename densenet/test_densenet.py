...
from densenet.keras_densenet import DenseNet

im = cv2.resize(cv2.imread('../timg.jpg'), (224, 224)).astype(np.float32)
...
if K.image_dim_ordering() == 'th':
    ...
    weights_path = '../ckpt/densenet121_weights_th.h5'
else:
    # Use pre-trained weights for Tensorflow backend
    weights_path = '../ckpt/densenet121_weights_tf.h5'
